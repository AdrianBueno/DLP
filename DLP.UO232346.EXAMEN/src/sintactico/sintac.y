...
l_sentencias	:																			{ List<Sentencia> sents = new ArrayList<Sentencia>(); $$ = sents;  } 
				...
				;
		/*: expresion '=' expresion ';'												{ $$ = new SenAsignacion($1, $3); }*/
sentencia		
				: l_expresion '=' l_expresion ';'											{ $$ = new SenAsignacion($1,$3); }											
...
l_expresion		: l_expresion ',' expresion														{ List<Expresion> exprs = (List<Expresion>)$1; exprs.add((Expresion)$3); $$ = exprs;  }
				| expresion																	{ List<Expresion> exprs = new ArrayList<Expresion>(); exprs.add((Expresion)$1); $$ = exprs; }
				;
...
expresion		: expresion '+' expresion													{ $$ = new ExAritmetica($1,"+",$3); }
				...
				| expresion '^' expresion													{ $$ = new ExLogica($1,"^",$3); }
